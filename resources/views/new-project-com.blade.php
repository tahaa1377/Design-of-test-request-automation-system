...
@section('section')
    ...
    <div class="form_pro fonting">
        ...
        <h4>فرم تست برای شرکت ها</h4>

        <br>


        <form action="/payment_com" method="post">
            ...
            <div class="form-group">
                <input type="text" class="form-control fonting" name="uni" placeholder="نام شرکت">
                <small  class="form-text text-muted"></small>
            ...
            <table style="direction: rtl" class="table table-hover">
                ...
                <tr class="maina">
                    ...
                    <td>
                        <div class="prrr"><?=number_format($test->company_price)?></div>
                    </td>
                    <td>
