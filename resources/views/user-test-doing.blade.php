...
@section('section')
    ...
    <br>
    <a href="/home" type="button" class="btn btn-dark fonting" style="float: left;margin-left: 10%">بازگشت</a>
    <br>
    <br>
    <h2 class="fonting" style="text-align: center">تست های در حال انجام من</h2>
    <hr>
            ...
            <table style="direction: rtl;width: 85%;" class="table table-hover fonting m-auto">
                ...
                <tr>
                    <td>
                        ...
                        <a href="/messengerU/<?=encode($noti->form_id)?>" style="color: white" type="button" class="btn btn-info"><i class="fa fa-envelope" aria-hidden="true"></i>
            ...
            <table style="direction: rtl;width: 85%;" class="table table-hover fonting m-auto">
                ...
                <tr>
                    <td>
                        ...
                        <a href="/messengerU/<?=encode($noti->form_id)?>" style="color: white" type="button" class="btn btn-info"><i class="fa fa-envelope" aria-hidden="true"></i>                            پیام ها <span class="badge badge-light">0</span>
                            <span class="sr-only">unread messages</span>
                        </a>
                    </td>
