...
@section('section')
    ...
    <h2 class="fonting" style="text-align: center">تست های در حال انجام</h2>
    <hr>
    <? foreach ($notif as $noti){ ?>
    <table  style="direction: rtl;width: 85%;border: 1px solid black" class="table
    table-hover fonting m-auto table-bordered">
        <colgroup style="border: 1px solid #000000">
            <col style="width: 10%;">
            <col style="width: 10%;">
            <col style="width: 30%;">
            <col style="width: 10%;">
...
<br>
    ...
    table-hover fonting m-auto table-bordered">
        ...
        <table  style="direction: rtl;width: 85%;" class="table table-hover fonting m-auto table-striped table-bordered">
            ...
            <?}?>
            <table style="direction: rtl;width: 85%;" class="table table-hover fonting m-auto table-bordered">
                <colgroup style="border: 1px solid #636b6f">
                    <col style="width: 10%;">
                    <col style="width: 10%;">
                </colgroup>
